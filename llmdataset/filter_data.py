...
def filter_data(filePath):
    ...
    # Specify the columns to load and their new names
    column_names = {
        'reviewerID': 'userId',
        'asin': 'itemId',
        'overall': 'Rating',
    ...
    ratings = pd.read_csv(filePath, delimiter=",", encoding="latin1", usecols=column_names.keys())
    
    # Rename the columns
    ratings.rename(columns=column_names, inplace=True)
...
datapath = '/scratch/dmeher/datasets_recguru/'
data_name_s = 'books'
data_name_t = 'movie'
save_path = '/scratch/dmeher/datasets_recguru/'
...
data_dic = {'sport':'ratings_Sports_and_Outdoors',
            'cloth':'ratings_Clothing_Shoes_and_Jewelry','cell':'ratings_Cell_Phones_and_Accessories',
            'beauty':'All_Beauty_5', 'appliances':'Appliances_5', 
            'electronics': 'reviews_Electronics_5', 'food': 'reviews_Grocery_and_Gourmet_Food_5',
            'books':'reviews_Books_5','movie':'reviews_Movies_and_TV_5', 'music':'reviews_CDs_and_Vinyl_5'
            }
